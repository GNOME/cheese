...
void cheese_command_handler_run_command_from_string (GtkMenuItem *, gpointer);
void cheese_command_handler_url_show (GtkIconView *, GtkTreePath *);
void cheese_command_handler_about_me_update_photo (GtkWidget *, gpointer);
